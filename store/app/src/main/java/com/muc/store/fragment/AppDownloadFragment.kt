...
@LayoutBinder(R.layout.fragment_app_download)
class AppDownloadFragment : BaseFragment() {
    @ViewBinder(R.id.app_download_rv)
    private lateinit var mRecyclerView: RecyclerView

    @ViewBinder(R.id.app_download_srl)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mSwipeRefreshLayout.setOnRefreshListener {
            ...
            mAdapter.update("app_download.php")
        }
